# Surf-ios
Данный проект выполнен в рамках тестового задания в Surf.
...
# Реализация
* Модальное окно сделано с помощью UIView с добавлением UIPanGestureRecognizer. Реализовано два положения модального окна.
* Бесконечная карусель реализована с помощью UICollectionView. При тапе на элемент происходит его перемещение на первую позицию.
* По нажатию на кнопку «Отправить заявку», если элемент выбран отображается системный алерт с заголовком «Поздравляем!» и текстом «Ваша заявка успешно отправлена!». По нажатию на кнопку «Отправить заявку», если элемент не выбран отображается системный алерт «Ошибка!» и текстом «Вы не выбрали язык программирования!»
* Реализована локализация русский английский языки.
* Адаптивная вёрстка.

# Демонстрация работы приложения

![surf](https://user-images.githubusercontent.com/109849742/218314656-079da2b3-9399-4a8b-9005-cabee2212bca.gif)
